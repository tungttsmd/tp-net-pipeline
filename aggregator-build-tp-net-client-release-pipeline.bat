@echo off
chcp 65001 >nul
title Build Tp-net-client-release
...
set RELEASE_REPO=tp-net-client-release
...
%GIT% clone --branch %BRANCH% --single-branch %BASE_URL%/tp-net-client-cloudflared-service
%GIT% clone --branch %BRANCH% --single-branch %BASE_URL%/tp-net-librehwmonitor
%GIT% clone --branch %BRANCH% --single-branch %BASE_URL%/tp-net-agent
...
rmdir /s /q tp-net-client-cloudflared-service\.git 2>nul
rmdir /s /q tp-net-librehwmonitor\.git 2>nul
rmdir /s /q tp-net-agent\.git 2>nul
...
move tp-net-client-cloudflared-service %RELEASE_REPO%\
move tp-net-librehwmonitor %RELEASE_REPO%\
move tp-net-agent %RELEASE_REPO%\
...
%GIT% add .
%GIT% commit -m "tp-net-client-release-0.0.1"
